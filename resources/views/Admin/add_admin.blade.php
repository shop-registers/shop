...
<head>
    ...
    <link rel="stylesheet" href="/dsh/layui-v2.5.4/layui/css/layui.css">
    <script src="/dsh/layui-v2.5.4/layui/layui.js"></script>
...
{{--                <form   class="form-horizontal">--}}
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" placeholder="您的账号" name="name" class="form-control">
                        <span id="names"></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="password" placeholder="您的密码" name="pwd" class="form-control">
                            <span id="pwd"></span>
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="email" placeholder="您的邮箱" class="form-control" name="email">
                            <span id="email"></span>
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="tel" name="tel" placeholder="您的电话" class="form-control">
                            <span id="tel"></span>
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
