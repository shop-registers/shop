                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal" action="save">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="sortnum" value="{{$data->sortnum}}" class="form-control">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                @if($data['is_show'] == 0)
                                    <div class="radio">
                                        <label>
                                            <input type="radio" value="0" id="optionsRadios1" name="is_show">是</label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input type="radio" checked value="1" id="optionsRadios2" name="is_show">否</label>
                                    </div>
                                @else
                                    <div class="radio">
                                        <label>
