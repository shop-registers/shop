...
<head>
    ...
    <link href="/dsh/css/font-awesome.min.css?v=4.4.0" rel="stylesheet">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="{{url('show_role')}}" class="J_menuItem"><i class="fa fa-edit"></i> <span class="nav-label">管理员角色管理</span></a>
{{--                    <ul class="nav nav-second-level">--}}
{{--                        <li><a class="J_menuItem" href="{{url('add_role')}}">添加管理员角色</a>--}}
{{--                        </li>--}}
{{--                        <li><a class="J_menuItem" href="{{url('show_role')}}">管理员角色列表</a>--}}
{{--                        </li>--}}
{{--                    </ul>--}}
                </li>

                <li>
                    <a  class="J_menuItem" href="{{url('show_admin')}}"><i class="fa fa-desktop"></i> <span class="nav-label"></span>管理员管理</a>
{{--                    <ul class="nav nav-second-level">--}}
{{--                        <li><a class="J_menuItem" href="{{url('add_admin')}}">添加管理员</a>--}}
{{--                        </li>--}}
{{--                        <li><a class="J_menuItem" href="">管理员列表展示</a>--}}
{{--                        </li>--}}
{{--                    </ul>--}}
                </li>
                <li class="line dk"></li>
...
<!-- 全局js -->
<script src="/dsh/js/jquery.min.js?v=2.1.4"></script>
<script src="/dsh/js/bootstrap.min.js?v=3.3.6"></script>
<script src="/dsh/js/plugins/metisMenu/jquery.metisMenu.js"></script>
<script src="/dsh/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
<script src="/dsh/js/plugins/layer/layer.min.js"></script>

<!-- 自定义js -->
<script src="/dsh/js/hAdmin.js?v=4.1.0"></script>
<script type="text/javascript" src="/dsh/js/index.js"></script>

<!-- 第三方插件 -->
<script src="/dsh/js/plugins/pace/pace.min.js"></script>
