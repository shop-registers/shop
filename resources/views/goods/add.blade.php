            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="POST" class="form-horizontal" action="good_add" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="radio i-checks">
                                        <label>
                                            <input type="radio" value="0" name="is_show"> <i></i>下架
                                            <input type="radio" value="1" name="is_show"> <i></i>上架
                                        </label>
                                    </div>
                                </div>
                            </div>
