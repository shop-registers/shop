    ...
    <div id="wrapper">
                         ...
                         <ul class="nav nav-second-level">
                            <li>
                                <ul class="nav nav-third-level">
                                    ...
                                    <a class="J_menuItem" href="form_editors.html"><?php echo $v1['name'];?></a>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </li>
                                </ul>
                            </li>
                            <li>
                            <a class="J_menuItem" href="layerdate.html"><?php echo $v['name'];?></a>
                            </li>
                        </ul>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row border-bottom">
               ...
               <h3>你好,<span style="color:blue"><?php echo e($user_name); ?></span> 欢迎来到电商后台。当前时间：<span style="color:blue"><?php echo e(date('Y-m-d H:i:s',$time)); ?></span></h3>
