                    ...
                    <div class="ibox-content">
                        <form method="POST" class="form-horizontal" action="add" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select class="form-control m-b" name="brand_id">
                                        ...
                                        <?php $__currentLoopData = $brand; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($info->id); ?>"><?php echo e($info->brand_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group m-b"><span class="input-group-addon">&yen;</span>
                                    <input type="text" class="form-control" name="good_old_price"><span class="input-group-addon">.00</span>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
