...
<div class="x-body">
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <?php $__currentLoopData = $v->role_rbac; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vals): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

           <?php if($vals->rbac): ?>
               <?php echo e($vals->rbac->name); ?>,
               <?php endif; ?>
            ...
            <td class="td-status">
                ...
                <a title="编辑" href="<?php echo e(url('/upd_role',['id'=>$v['id']])); ?>">
