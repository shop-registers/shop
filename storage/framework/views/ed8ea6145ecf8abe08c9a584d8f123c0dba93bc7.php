                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($item->attr_name); ?></td>
                                        <td><span class="pie"><?php echo e($item->attr_desc); ?></span>
                                        </td>
                                        <td><?php echo e($item->good_id); ?></td>
                                        <td><a href="attr_del?id=<?php echo e($item->id); ?>"><button type="button" class="btn btn-sm btn-primary"> 删除</button></a>
                                            <a href="attr_upd?id=<?php echo e($item->id); ?>"><button type="button" class="btn btn-sm btn-primary"> 修改</button></a>
                                        </td>
                                    </tr>
